...
const STRINGS = {
  es: {
    ...
    about: {
      ...
      body1: "Desarrollador full-stack con foco en backend. Diseño e implemento bases de datos y APIs pensadas para grandes volúmenes de datos.",
      body2: "Más de 4 años en desarrollo de software (web y embebidos, C/C++ y Python). Mi base de desarrollo me permite automatizar el trabajo con datos en lugar de hacerlo a mano. Actualmente curso la Tecnicatura Superior en Sistemas Embebidos e IoT.",
  ...
  en: {
    ...
    about: {
      ...
      body1: "Full-stack developer focused on the backend. I design and implement databases and APIs built for large data volumes.",
      body2: "4+ years in software development (web and embedded, C/C++ and Python). My development background lets me automate data work instead of doing it by hand. I'm currently studying a Higher Technician degree in Embedded Systems & IoT.",
      nowTitle: "Right now",
